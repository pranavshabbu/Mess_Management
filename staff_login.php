...
if($_SERVER['REQUEST_METHOD']=="POST")
{
    ...
    if(!empty($id) && !empty($pass))
    {
        ...
        if($result)
        {
            ...
            {
                header("Location: staff_options.html");
                die;
            }
            else{
                echo("Invalid info");
...
<html>
    ...
    <body>
        ...
        <form method="POST" action="staff_login.php">
            <label class="label1">Enter staff id</label>
            <input class="idfield" type="number" name="staffid" id="staffid" required>
            <br><br>
            <label class="label2">Enter password</label>
            <input class="passfield" type="password" name="staffpass" id="staffpass" required>
            <br><br>
            <input class="login" type="Submit" id="staffauth" value="Login">
            <br><br>
        </form>
